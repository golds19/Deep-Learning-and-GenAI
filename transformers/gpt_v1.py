...
class GPTDatasetV1(Dataset):
    def __init__(self, txt, tokenizer, max_length, stride):
        ...
        # Use a sliding window to chunk the book into overlapping sequences of max lengths
...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        # compute scaled dot product for attention scores
...
def main():
    ...
    start_context = "Hello, there, i am"
